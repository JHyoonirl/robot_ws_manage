...
class Passive_mode:
    def __init__(self):
        ...
        self.theta_max = self.reha.theta_max
        self.theta_min = self.reha.theta_min
        self.hold_time = self.reha.hold_time
        self.Dtheta_max = self.reha.Dtheta_max
        self.DDtheta_time = self.reha.DDtheta_time
        self.repeatation_number = self.reha.repeatation_number #설정 반복 횟수
        self.Thruster_acc = self.reha.Thruster_acc # thrust의 변화률
        self.ACCELERATION_TIME = self.reha.ACCELERATION_TIME
        self.dtheta_desired_current = self.reha.dtheta_desired_current
        self.dt = self.reha.dt
